...
class App extends React.Component{
  ...
  //function for unlocking the ipod if select-button is pressed on lock screen
	unlocking = () => {
  ...
  // change menu item list
	...
	// function to come back from sub-menu
	backMenu = () => {
	...
	changeTheme = (screen, menu, menuItem) => {
		if(screen === 3 && menu === 3){
			...
			select_btn.addEventListener('click', function(){
				...
				if(selected_theme === 0)
				{
					document.getElementsByClassName('frame')[0].style.background = 'rgb(74 72 72)';
					...
					document.getElementsByClassName('frame')[0].style.background = 'silver';
